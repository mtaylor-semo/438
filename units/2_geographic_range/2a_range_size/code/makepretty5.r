...
hist(numSpecies, breaks=seq(0,highSp,5), xlim=c(0,highSp), xlab = 'Number of Species', ylab = 'Number of Watersheds', main=paste('Frequency Distribution of Species Richness\nfor', theTaxon, 'in', theState, 'Watersheds', sep=' '), las=1)
