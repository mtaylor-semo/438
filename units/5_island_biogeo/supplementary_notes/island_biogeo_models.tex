...
\graphicspath{%
	...
	{/Users/goby/teach/438/units/5_island_biogeo/slides/}}
...
\begin{marginfigure}%
	\centering
	\includegraphics{island_intro}\\
	\includegraphics{patch_reefs}\\
	\includegraphics{big_oak_tree_sp}\\
	\includegraphics{pothole_lakes}\\
	\includegraphics{cave}
\end{marginfigure} 
...
\begin{marginfigure}%
	...
	tinyisland/.style={font=\tiny,circle,draw=black,fill=black!10,thick,minimum size=0mm,text width=0.5cm,align=center}]
		\path	node at (3,-0.8)	[mainland]		{Mainland Source}
				node at (1.7,-2.5)	[bigisland]		{Island 1}
				node at (4.5,-2.5)	[tinyisland]	{Island 2}
				node at (1.7,-4.6)	[tinyisland]	{Island 3}
				node at (4.5,-4.6)	[bigisland]		{Island 4};
	\end{tikzpicture}
	\end{marginfigure} 
...
\begin{marginfigure}%
	\centering
	\includegraphics[page=20]{island_biogeography_models.pdf}\\
	\includegraphics[page=21]{island_biogeography_models.pdf}\\
\end{marginfigure} 
...
\begin{marginfigure}%
	\centering
	\includegraphics{sequential_equilibria}\\
\end{marginfigure} 
...
\cofeAm{0.14}{0.75}{2}{-0.5cm}{-0.5cm}
