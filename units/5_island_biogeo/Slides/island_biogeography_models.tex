...
\begin{frame}{Species turnover was lower than predicted on ``near'' islands.}
	...
	\pause
	\begin{center}
		The \highlight{rescue effect} occurs when high immigration rates reduce extinction rates.
	\end{center}
\end{frame}
...
\begin{frame}{Species turnover was higher than predicted on ``large'' islands.}
	...
	The \highlight{target effect} can occur on large islands due to high immigration.
