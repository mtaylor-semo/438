...
\includegraphics[width=\linewidth]{rstudio_three_panes}
...
I suggest you click the small “Split Pane” button (\includegraphics[width=0.5cm]{rstudio_split_pane_button}) in the upper right of the console pane to give you a source code pane (shown below) that use the source code pane later.

\includegraphics[width=\linewidth]{rstudio_four_panes}
...
\quad\includegraphics[width=0.95\linewidth]{rstudio_general_settings}
\end{multicols}
...
\includegraphics[width=\linewidth]{rstudio_to_source}
