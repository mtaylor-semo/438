...
\fancyhead[LE,RO]{\footnotesize R Tutorial \thepage}
...
\end{verbatim}
\begin{alltt}
\hlstd{A} \hlkwb{<-} \hlnum{3} \hlopt{+} \hlnum{2}  \hlcom{# Assign the result to variable A.}
\hlkwd{message}\hlstd{(}\hlstr{"The <- is an assignment operator. It places the result into a variable."}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The <- is an assignment operator. It places the result into a variable.}}\begin{alltt}
\hlkwd{message}\hlstd{(}\hlstr{"In this case, the result of 3+2 is stored in the variable \textbackslash{}"A\textbackslash{}"."}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# In this case, the result of 3+2 is stored in the variable "{}A"{}.}}\end{kframe}
\end{knitrout}
