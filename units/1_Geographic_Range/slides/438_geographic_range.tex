...
\begin{frame}[t,plain]{The geographic range reflects the species’ niche.}
...
\begin{frame}[t,plain]{Abundance and density is highest near the center of the range. Why?}
	\begin{center}
...
\begin{frame}[b,plain]{\highlight{Habitat quality} influences abundance and density.}

\end{frame}
}

\begin{frame}[t,plain]{\highlight{Metapopulations} have cycles of extinction and colonization.}
	\begin{center}
...
\begin{frame}[b,plain]{Floods restore sediment and nutrients.}
...
\begin{frame}[t,plain]{Closely related species have \highlight{allopatric} distributions.}
\end{frame}
}
