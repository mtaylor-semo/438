...
\begin{enumerate}[resume]
\item Run the following command to install certain R packages and set up necessary variables.%\textbf{If and only if you quit RStudio since the previous exercise,} rerun \textsc{source("setup.r")} to load the libraries and functions needed for this exercise. Disregard this part if you haven't quit RStudio.
...
get a sense of your results. Dr.~Taylor can help you locate the watersheds on the big map.%\emph{Here is where I ran out of time. Ask for help.} %
