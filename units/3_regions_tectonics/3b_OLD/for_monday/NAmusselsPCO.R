...
plot(nataxa.pco$points, main = 'North American Mussels PCO', xlab = 'PCO 1', ylab = 'PCO 2', col=mycolors[nataxa.clust.cut], pch=nataxa.clust.cut)

text(nataxa.pco$points, labels = rownames(nataxa), col=mycolors[nataxa.clust.cut], adj=1.1, cex=0.8)
abline(h=0, col='grey50')
abline(v=0, col='grey50')

#plot(nataxa.pco$points[,2], nataxa.pco$points[,3], main = 'North American Mussels PCO 2 x 3', xlab = 'PCO 2', ylab = 'PCO 3', col=mycolors[nataxa.clust.cut], pch=nataxa.clust.cut)
...
#cloud(pco.mat[,3]~pco.mat[,1]*pco.mat[,2], pch=19, groups = nataxa.clust.cut, xlab='PCO 1', ylab = 'PCO 2', zlab = 'PCO 3', main = 'North American Mussels\nPrincipal Coordinates Analysis')
